...
ggplot(LASSO_mod_output, aes(y=resid,x=Wt)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=Ht)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=Hand)) +
    geom_boxplot() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=DftRd)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()

ggplot(LASSO_mod_output, aes(y=resid,x=G)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()

ggplot(LASSO_mod_output, aes(y=resid,x=A1)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=DftYr)) + #could be non linear babes
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=dzFOL)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=Country)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=GP)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=Position)) +
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
ggplot(LASSO_mod_output, aes(y=resid,x=SA)) + #could be non linear babes
    geom_point() +
    geom_smooth(color = "blue", se = FALSE) +
    geom_hline(yintercept = 0, color = "red") + 
    theme_classic()
