...
data_rec <- recipe(success ~ Ht + Wt + Hand + DftRd + G + A1 + Country + GP + Position + SA + rookie, data = NHL)
...
Success_final_fit <- fit(data_wf_final, data = NHL)
...
Success_final_fit %>% extract_fit_engine() %>% rpart.plot()
```
